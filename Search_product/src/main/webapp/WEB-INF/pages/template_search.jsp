...
<!-- scripts -->
<script src="${pageContext.request.contextPath}/assets/script/jquery-3.1.0.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/assets/script/bootstrap.min.js" type="text/javascript"></script>
